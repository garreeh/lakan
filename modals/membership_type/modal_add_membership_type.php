<div class="modal fade" id="addMembershipModal" tabindex="-1" role="dialog" aria-labelledby="addMembershipModalLabel"
  aria-hidden="true">
        ...
        <form method="post" enctype="multipart/form-data">
          <div class="form-row">
            ...
            <div class="input-group mb-3">
              ...
              <div class="form-floating flex-grow-1">
                <input type="text" class="form-control" id="membership_type_name" name="membership_type_name"
                  placeholder=" Membership Type Name" required>
            ...
            <div class="input-group mb-3">
              ...
              <div class="form-floating flex-grow-1">
                <input type="text" class="form-control" id="membershiptype_price" name="membershiptype_price"
                  placeholder="Membership Type Price" required>
            ...
            <div class="input-group mb-3">
              ...
              <div class="form-floating flex-grow-1">
                <input type="text" class="form-control number-only" id="discount" name="discount"
            ...
            <div class="input-group mb-3">
              ...
              <div class="form-floating flex-grow-1">
                <textarea class="form-control" id="membershiptype_description" name="membershiptype_description"
                  placeholder="Membership Type Description" style="height: 100px"></textarea>
