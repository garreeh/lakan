        ...
        <div class="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Employee Archives</li>
            </ol>
          </nav>
                ...
                <div class="col-xl-12 col-lg-12">
                  <div class="tab-pane fade show active" id="aa" role="tabpanel" aria-labelledby="aa-tab">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table custom-table table-hover" name="users_archive_table" id="users_archive_table">
                        <thead>
                          <tr>
                            <th>ID</th>
                            <th>Employee #</th>
...
<script>
  $('.toggle-sidebar-btn').click(function() {
    $('#users_archive_table').css('width', '100%');
  ...
  $(document).ready(function() {
    var users_archive_table = $('#users_archive_table').DataTable({
      ...
      "processing": true,
      "serverSide": true,
      "ajax": "./../controllers/tables/employee_archived_table.php",
      "order": [
        [0, "desc"]
  ...
  $(document).ready(function() {
    ...
    $('#users_archive_table').on('click', 'tr td:nth-child(8) .fetchDataUser', function() {
  ...
  $(document).ready(function() {
    // Function to handle click event on datatable rows
    $('#users_archive_table').on('click', 'tr td:nth-child(8) .fetchDataUserDelete', function() {
      var user_id = $(this).closest('tr').find('td').first().text(); // Get the user_id from the clicked row
      console.log('Button clicked, User ID: ' + user_id);
