...
<head>
  ...
  <title>Lakan | Coaching Service</title>
        ...
        <div class="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Coaching Service</li>
            </ol>
          </nav>
        ...
        <section class="section dashboard">
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <?php include './../modals/coaching/modal_add_coaching.php'; ?>
              <a href="#" class="btn btn-sm btn-success shadow-lg mb-4" data-bs-toggle="modal"
                data-bs-target="#addCoachingModal">
                <i class="bi bi-plus"></i> Add Coaching Session
              </a>
                ...
                <div class="col-xl-12 col-lg-12">
                  <div class="tab-pane fade show active" id="aa" role="tabpanel" aria-labelledby="aa-tab">
                    ...
                    <div class="table-responsive">
                      <div id="modalContainerCoachingServ"></div>

                      <table class="table custom-table table-hover" name="coaching_table" id="coaching_table">
                        <thead>
                          <tr>
                            <th>ID</th>
                            <th>Client Name</th>
...
<script>
  ...
  $('.toggle-sidebar-btn').click(function () {
    $('#coaching_table').css('width', '100%');
    // console.log(table) //This is for testing only
  });

  // Table for Membership Type
  $(document).ready(function () {
    var coaching_table = $('#coaching_table').DataTable({
      "pagingType": "numbers",
      "processing": true,
      "serverSide": true,
      "ajax": "./../controllers/tables/coaching_table.php",
      "order": [
        [0, "desc"]
